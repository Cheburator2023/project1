...
const processArtefactsMrmToSum = async () => {
  ...
  const mrmSelectSql = `
    select 
      model_id,
      case 
        when arn.artefact_value_id = ${getIdByValue(mrmArtefactValues, ART_1)} then ${getIdByValue(sumArtefactValues, ART_1)}
        when arn.artefact_value_id = ${getIdByValue(mrmArtefactValues, ART_2)} then ${getIdByValue(sumArtefactValues, ART_2)}
        when arn.artefact_value_id = ${getIdByValue(mrmArtefactValues, ART_3)} then ${getIdByValue(sumArtefactValues, ART_3)}
        when arn.artefact_value_id = ${getIdByValue(mrmArtefactValues, ART_4)} then ${getIdByValue(sumArtefactValues, ART_4)}
        when arn.artefact_value_id = ${getIdByValue(mrmArtefactValues, ART_5)} then ${getIdByValue(sumArtefactValues, ART_5)}
        when arn.artefact_value_id = ${getIdByValue(mrmArtefactValues, ART_6)} then ${getIdByValue(sumArtefactValues, ART_6)}
        else null
