...
import { isTakenOutOfOperationModels as isTakenOutOfOperationSumModels } from './sql/sum';
import { isTakenOutOfOperationModels as isTakenOutOfOperationSumRmModels } from './sql/sum-rm';

@Injectable()
export class OutOfOperationService {
  constructor(
  ...
  private calculateDeltaByStringValue(
    ...
    return this.calculatePercentageDelta(values.length, pastValues.length);
  }
