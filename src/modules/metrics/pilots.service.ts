...
import { isStage05A as isSumStage05A } from './sql/sum';
...
export class PilotsService {
  ...
  private async getModels(
    ...
    const sumRawData = await this.sumDatabaseService.query(isSumStage05A, {})
    const sumRmRawData = await this.mrmDatabaseService.query(isSumRmStage05A, {})
