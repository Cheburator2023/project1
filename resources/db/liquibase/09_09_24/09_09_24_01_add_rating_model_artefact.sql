...
--changeset d.kravchenko:09_09_24_01_add_rating_model_artefact
--comment: Добавление артефакта rating_model
...
VALUES ((SELECT MAX(artefact_id) + 1 FROM artefacts), 'rating_model', 'Рейтинговая модель', '', null, '0', '0', '1', 3, 1, '0', null,
        null, null, null, '', null);
